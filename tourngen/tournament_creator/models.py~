...
class Fixture(models.Model):
    fixture_id = models.IntegerField(db_column='Fixture_id', primary_key=True) # Field name made lowercase.
...
class Match(models.Model):
    ...
    info = models.TextField(db_column='Info', blank=True) # Field name made lowercase.
    last_updated = models.TextField(db_column='Last_updated') # Field name made lowercase.
    status = models.IntegerField(db_column='Status') # Field name made lowercase.
